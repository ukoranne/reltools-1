...
ifeq (,$(findstring $(PKG_BUILD), FALSE))
	install $(SRCDIR)/$(BUILD_DIR)/bin/confd $(DESTDIR)/$(EXT_INSTALL_PATH)/bin
	install $(SRCDIR)/$(BUILD_DIR)/bin/arpd $(DESTDIR)/$(EXT_INSTALL_PATH)/bin
	install $(SRCDIR)/$(BUILD_DIR)/bin/bgpd $(DESTDIR)/$(EXT_INSTALL_PATH)/bin
	install $(SRCDIR)/$(BUILD_DIR)/bin/ribd $(DESTDIR)/$(EXT_INSTALL_PATH)/bin
	install $(SRCDIR)/$(BUILD_DIR)/bin/portd $(DESTDIR)/$(EXT_INSTALL_PATH)/bin
	install $(SRCDIR)/$(BUILD_DIR)/bin/asicd $(DESTDIR)/$(EXT_INSTALL_PATH)/bin
	install $(SRCDIR)/$(BUILD_DIR)/bin/lacpd $(DESTDIR)/$(EXT_INSTALL_PATH)/bin
endif
